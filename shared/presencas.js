...
function garantirEstilos() {
  ...
  .pg-wrap{overflow:auto;max-height:calc(100vh - 250px);border:1px solid var(--line);border-radius:12px;background:#fff}
  ...
  th.resumo,td.resumo{position:sticky;right:0;background:#fff;border-left:1px solid var(--line);padding:6px 10px;min-width:120px;text-align:left;font-size:11.5px;z-index:1}
  thead th.resumo{z-index:3}
