...
import { moduloEquipa } from "./modules/equipa.js";
...
import { moduloOrcamento } from "./modules/orcamento.js";
import { moduloMapeamento } from "./modules/mapeamento.js";
...
const MODULOS = [moduloDashboard, moduloEquipa, moduloHSK, moduloFB, moduloNautico, moduloServicos, moduloAlojamento, moduloEscalas, moduloParametros, moduloControloGestao, moduloOrcamento, moduloMapeamento];
...
const GRUPOS_NAV = [
  ...
  { titulo: "Operação",     ids: ["equipa", "hsk", "fb", "nautico", "servicos", "alojamento", "escalas"] },
  { titulo: "Planeamento",  ids: ["parametros", "orcamento", "controlo", "mapeamento"] },
  { titulo: "Sistema",      ids: ["zonas"] }
];
