...
const MODULOS = [moduloDashboard, moduloEquipa, moduloHSK, moduloFB, moduloNautico, moduloServicos, moduloAlojamento, moduloEscalas, moduloParametros, moduloControloGestao, moduloOrcamento, moduloAtualizacoes];
...
const GRUPOS_NAV = [
  ...
  { titulo: "Planeamento",  ids: ["parametros", "orcamento", "controlo"] },
