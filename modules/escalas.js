...
const M = { base: null, erro: null, fonte: "Junho", semana: null };
...
export const moduloEscalas = {
  ...
  render(core, alvo) {
    ...
    alvo.replaceChildren(
      el("div", { class: "mod-cab" }, el("h2", {}, "🗓️ Escalas — Housekeeping"),
        el("p", { class: "mut" }, "Necessidades calculadas a partir das room nights do forecast (" + M.fonte + "). Alocação, gaps e excessos.")),
      bar,
      kpis(esc),
