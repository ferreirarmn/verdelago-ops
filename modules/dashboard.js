...
function garantirEstilos() {
  ...
  .kpi .v{font-size:26px;font-weight:700;color:var(--teal);line-height:1}
  ...
  .dtab{width:100%;border-collapse:collapse;font-size:13.5px;background:#fff;border:1px solid var(--line);border-radius:11px;overflow:hidden}
  .dtab th{background:var(--soft);text-align:left;padding:9px 12px;font-size:12px;color:var(--teal-d)}
  .dtab td{padding:9px 12px;border-top:1px solid var(--line)}
