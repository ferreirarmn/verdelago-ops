...
// necessidade de F&B para um mês com covers. Posições/dia por área (todas
// variáveis) + HC de pessoas (× fator de folgas).
function previsaoFB(mesNome) {
  const fb = M.fb; if (!fb || !fb.ratios || !fb.covers || !fb.dias_mes?.[mesNome]) return null;
