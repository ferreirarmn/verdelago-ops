...
const SVG = {
  ...
  // Equipa (geral) — grupo de pessoas
  mapeamento: `<svg viewBox="0 0 24 24" ${P}><path d="M4 7h7M4 12h7M4 17h5"/><path d="M14 7l3 3 4-5M14 17l3 3 4-5"/></svg>`,
  equipa: `<svg viewBox="0 0 24 24" ${P}><circle cx="9" cy="8" r="3"/><path d="M3 20a6 6 0 0112 0"/><path d="M16 6.5a2.8 2.8 0 010 5M17.5 20a6 6 0 00-3-5.2"/></svg>`,
